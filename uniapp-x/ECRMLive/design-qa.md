...
- Implementation capture: `/private/tmp/ecrm-live-h5-register-current.png`.
- Full-view comparison: `/private/tmp/ecrm-live-register-reference-vs-h5.png`.
...
- Fonts and typography: the 29 px ECRMLive title, 14 px subtitle, 13 px labels, 15 px inputs and 16 px primary actions match the source hierarchy; platform rasterization differs between Harmony and browser.
